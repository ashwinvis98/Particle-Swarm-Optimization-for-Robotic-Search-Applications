...
light_sensor_c = Light(c, PORT_1, False)
...
def pso():
    ...
    if light_a < best_cost1:
        best_cost1=light_a
        best_x1=x
        best_y1=y

    if light_b < best_cost2:
        best_cost2=light_b
        best_x2=x2
        best_y2=y2

    if light_c < best_cost3:
        best_cost3=light_c
        best_x3=x3
        best_y3=y3
    ...
    while(True):
        ...
        if (dist>=40)&(abs(thetha-alpha)>7):
            ...
            if dist>=40:
                ...
                print("A reached!")
                a_reached=1
                light_a=light_sensor_a.get_input_values().scaled_value
    ...
    while(True):
        ...
        if (dist>=40)&(abs(thetha2-alpha2)>5):
            ...
            if dist>=40:
                ...
                print("B reached!")
                b_reached=1
                light_b=light_sensor_b.get_input_values().scaled_value
                if check_all_reached()==1:
                    break
    ...
    while(True):
        ...
        if (dist>=40)&(abs(thetha3-alpha3)>5):
            ...
            if dist>=40:
                ...
                print("C reached!")
                c_reached=1
                light_sensor_c=light_sensor_c.get_input_values().scaled_value
                if check_all_reached()==1:
                    break
